...
## Convert newline-separated input into a list of tuples
...
R31
"""
moves = [] # empty list to store tuples

for line in moves_str.splitlines():
    line = line.strip() # remove whitespace
    if line: # skip empty lines
        direction = line[0] # 'L' or 'R'
        amount = int(line[1:]) # convert number part
        moves.append((direction, amount)) # append tuple to list

result = safe_password(50, moves) # starting position is 50

print(result) # print the result of the safe_password function
#result shows 48 as final position and 1168 as the number of times the dial hit zero, which is correct for this input.


# Test area for any starting position and moves (all work as expected)
